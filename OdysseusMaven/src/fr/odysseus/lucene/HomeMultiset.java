...
/**
 * A {@link HomeMultiset} is a set that allows for duplicate elements. Two
 * {@link HomeMultiset}s are equal if they contain the same unique elements and if
 * each unique element has as many occurrences in both multisets.
 * Iteration order is not specified.
 * @lucene.internal
 */
public final class HomeMultiset<T> extends AbstractCollection<T> {

  private final Map<T, Integer> map = new HashMap<>();
  private int size;

  /** Create an empty {@link HomeMultiset}. */
  HomeMultiset() {
    super();
  }
  ...
  public boolean equals(Object obj) {
    ...
    HomeMultiset<?> that = (HomeMultiset<?>) obj;
