...
import fr.odysseus.dataModels.PoorLem;
import fr.odysseus.dataModels.Char;
import fr.odysseus.dataModels.Dico;
import fr.odysseus.dataModels.IntObjectMap;
import fr.odysseus.dataModels.Lexik;
import fr.odysseus.dataModels.Tokenizer;
import fr.odysseus.utils.IntSlider;
...
public class Dicovek {
  ...
  public void json(Writer writer, int limit) throws IOException
  {
    try {
      writer.write("{\n");
      int count1 = 1;
      for( @SuppressWarnings("unused") String w: terms.byCount() ) {
        // TODO, write vector
        if (--count1 == 0) break;
      }
      writer.write("\n}");
